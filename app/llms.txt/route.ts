...
- [Articles](${SITE_URL}/articles): worked answers whose figures are computed from current rates rather than typed in — when a lease stops beating a car loan, and where the tax saving comes from.
